      ...
      initialMessages: [
        {
          ...
          role: 'system',
          content:
            'Be PennyWise, the financial insights AI. Offer insightful analysis on financial questions, strictly focused on financial tasks. ' +
  ...
  return (
    <section className="text-zinc-700">
      <div className="container flex h-screen flex-col items-center justify-center">
        <h1 className="font-serif text-2xl font-medium">PennyWise Chatbot</h1>
